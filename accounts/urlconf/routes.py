"""
Application URL routing (tenant portal, dedicated admin portal, staff workspace routes).
"""
...
urlpatterns = [
    ...
    path('tenant/billing/', views.tenant_bills, name='tenant_billing'),
    path('tenant/reports/', views.tenant_reports, name='tenant_reports'),
    path(
        'tenant/reports/maintenance/create/',
        views.tenant_submit_maintenance,
        name='tenant_submit_maintenance',
    ),
    path(
        'tenant/reports/violation/create/',
        views.tenant_submit_violation,
        name='tenant_submit_violation',
    ),
    ...
    path(
        'billing/payments/<int:payment_id>/generate-receipt/',
        views.generate_payment_receipt,
        name='generate_payment_receipt',
    ),
    path(
        'billing/payments/<int:payment_id>/download-receipt/',
        views.download_payment_receipt,
        name='download_payment_receipt',
    ),
    path(
        'billing/payments/<int:payment_id>/send-receipt/',
    ...
    path(
        'maintenance/update/<int:report_id>/',
    ...
    path('rules/', rules_views.rules_list, name='rules_list'),
    path('rules/create/', rules_views.create_rule, name='create_rule'),
    path('rules/edit/<int:rule_id>/', rules_views.edit_rule, name='edit_rule'),
    path('rules/delete/<int:rule_id>/', rules_views.delete_rule, name='delete_rule'),
    path('tenant/rules/', rules_views.tenant_rules, name='tenant_rules'),
